...
copyfile("Tests/femm.nuspec", "femm/femm.nuspec")
copyfile("Tests/chocolateyinstall.ps1", "femm/tools/chocolateyinstall.ps1")
os.system("choco pack femm/femm.nuspec")
process = subprocess.Popen(["choco", "install", "femm.1.0.0.nupkg", "-y"])
