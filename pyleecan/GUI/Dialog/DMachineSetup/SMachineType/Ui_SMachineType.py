...
class Ui_SMachineType(object):
    def setupUi(self, SMachineType):
        ...
        sizePolicy.setHeightForWidth(self.in_machine_type.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.img_type_machine.sizePolicy().hasHeightForWidth())
        ...
        self.img_type_machine.setPixmap(QPixmap(u":/images/images/MachineSetup/MachineType/machine_SCIM.png"))
        ...
        sizePolicy4.setHeightForWidth(self.in_machine_desc.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, SMachineType):
        SMachineType.setWindowTitle(QCoreApplication.translate("SMachineType", u"Form", None))
        self.in_machine_type.setText(QCoreApplication.translate("SMachineType", u"Machine type :", None))
        self.c_type.setItemText(0, QCoreApplication.translate("SMachineType", u"SCIM (Squirrel Cage Induction Machine)", None))
        self.c_type.setItemText(1, QCoreApplication.translate("SMachineType", u"DFIM (Doubly Fed Induction Machine)", None))
        self.c_type.setItemText(2, QCoreApplication.translate("SMachineType", u"WRSM (Wound Rotor Synchronous Machine)", None))
        self.c_type.setItemText(3, QCoreApplication.translate("SMachineType", u"SIPMSM (Surface Inset Permanent Magnet Synchronous Machine)", None))
        self.c_type.setItemText(4, QCoreApplication.translate("SMachineType", u"IPMSM (Interior Permanent Magnet Synchronous Machine)", None))
        self.c_type.setItemText(5, QCoreApplication.translate("SMachineType", u"SynRM (Synchronous Reluctance Machine)", None))

        self.img_type_machine.setText("")
        self.groupBox.setTitle(QCoreApplication.translate("SMachineType", u"Machine description ", None))
        self.in_machine_desc.setPlaceholderText(QCoreApplication.translate("SMachineType", u"Machine Description", None))
        self.c_topology.setItemText(0, QCoreApplication.translate("SMachineType", u"Internal Rotor", None))
        self.c_topology.setItemText(1, QCoreApplication.translate("SMachineType", u"External Rotor", None))

        self.in_name.setText(QCoreApplication.translate("SMachineType", u"Machine name :", None))
        self.label.setText(QCoreApplication.translate("SMachineType", u"Topology : ", None))
        self.in_p.setText(QCoreApplication.translate("SMachineType", u"Pole pair number :", None))
        self.b_previous.setText(QCoreApplication.translate("SMachineType", u"Previous", None))
