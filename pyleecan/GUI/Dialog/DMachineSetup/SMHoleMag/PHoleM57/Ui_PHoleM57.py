...
class Ui_PHoleM57(object):
    def setupUi(self, PHoleM57):
        ...
        self.img_slot.setPixmap(QPixmap(u":/images/images/MachineSetup/SMHoleMag/HoleM57_mag_int_rotor.png"))
    ...
    def retranslateUi(self, PHoleM57):
        ...
        self.out_slot_surface.setText(QCoreApplication.translate("PHoleM57", u"Slot suface (2 part) : ?", None))
        self.out_magnet_surface.setText(QCoreApplication.translate("PHoleM57", u"Single Magnet surface : ?", None))
    # retranslateUi
