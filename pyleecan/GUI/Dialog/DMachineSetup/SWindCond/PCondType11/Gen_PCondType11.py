...
class Gen_PCondType11(Ui_PCondType11):
    def setupUi(self, PCondType11):
        ...
        txt = self.tr(u"""number of form wound strands in parallel per conductor along tangential (horizontal) direction""")
        ...
        txt = self.tr(u"""number of form wound strands in parallel per conductor along radial (vertical) direction""")
        ...
        # Setup of in_Hwire
        txt = self.tr(u"""cf schematics, single strand height without insulation""")
        ...
        # Setup of in_Wwire
        txt = self.tr(u"""cf schematics, single strand width without insulation""")
